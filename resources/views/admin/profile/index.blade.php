...
@section('content')
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-0">Admin Profile Management</h4>
                        <div class="mt-3">
                            @if ($errors->any())
                            ...
                            <form action="{{ route('profile.update', auth()->user()->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                      <img src="{{ asset('images/'.auth()->user()->profiles->image) }}" alt="{{ auth()->user()->profiles->image }}" width="300px" height="300px">
                                      <br>
