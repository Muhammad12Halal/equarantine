...
<head>
    ...
    <link href="{{ asset('panel/css/sb-admin-2.css') }}" rel="stylesheet">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-heading">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link collapsed" href="{{ route('covid.index') }}">
                        <i class="fas fa-fw fa-wrench"></i>
                        <span>Vaccine Information</span>
                    </a>
                    <a class="nav-link collapsed" href="{{ route('college.index') }}">
                        <i class="fas fa-fw fa-wrench"></i>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright Group 7:MKG1063</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
